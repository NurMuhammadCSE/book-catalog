        ...
        <div className="card-body">
          ...
          {verifiedUser && (
            <div className=" flex justify-end">
              <button className="btn  text-info text-2xl">
                {readinglisted ? (
              ...
              <button className="btn  text-error text-2xl">
                {wishlisted ? (
          ...
          <figure>
            <img
              className="w-80 rounded h-80 overflow-hidden"
              src={book.image}
              alt=""
            />
          </figure>
          <div className="badge badge-sm badge-primary">{book?.author}</div>
